...
//  MiniApp
//
//  Created by Rafael Magana  on 15/11/24.
//
...
struct InformationView:View {
    ...
    var body: some View {
        ...
        }.frame(maxWidth: .infinity, maxHeight: .infinity).background(.component).cornerRadius(16).padding(16)
    }
}
...
#Preview {
    IMCResultView(userWeight: 96.0, userHeight: 188)
}
